    ...
    return (
        <div className='relative lg:h-[70vw] md:h-[130vw] sm:h-[150vw]'>
            ...
            <div className='absolute bg-[#000000d8] flex flex-col gap-4 h-[600px] px-20 py-20 left-[50%] -translate-x-[50%] mt-28 z-50  '>
                ...
                <div><input type='password' placeholder='Password' className='w-[320px] h-[50px] rounded-md  placeholder-shown:bg-[#333333] outline-none pl-2 border-b-orange-400 border-b tracking-wider' />
                    <FaEye />
                </div>
